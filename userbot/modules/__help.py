...
async def cmd_list(event):
    ...
    if args:
        ...
        try:
            ...
            await edit_delete(event, f"** Sepertinya obrolan atau bot ini tidak mendukung inline mode. Untuk Mengaktifkanya silahkan ketik .helpme**")
