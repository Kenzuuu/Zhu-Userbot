...
async def logaddjoin(Zhu):
    user = await Zhu.get_user()
    ...
    if kyy.user_added:
        ...
        return
    await Zhu.client.send_message(BOTLOG_CHATID, text)
...
@Zhu_cmd(pattern="gruplog (on|off)$")
