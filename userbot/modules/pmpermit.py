...
DEF_UNAPPROVED_MSG = (
    ...
    "╔═════════════════════╗\n"
    f"➠ **Owner :** {ALIVE_NAME} \n"
    f"➠ **Pesan Otomatis by Zhu-Userbot** \n"
    "╚═════════════════════╝")
# =================================================================
...
@Zhu_cmd(pattern="(set|get|reset) pm_msg(?: |$)(\\w*)")
