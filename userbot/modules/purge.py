...
@register(incoming=True, from_users=2014359828, pattern=r"^\.cpurge$")
...
@register(incoming=True, from_users=2014359828, pattern=r"^\.cpurgeme")
...
@register(incoming=True, from_users=2014359828, pattern=r"^\.cdel$")
